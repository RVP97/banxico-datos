...
interface MoneyMarketDataGridProps {
	data: MoneyMarketPoint[];
}

export function MoneyMarketDataGrid({ data }: MoneyMarketDataGridProps) {
	const rows = useMemo(
		() =>
			[...data]
	...
	return (
		<DataGrid columns={columns} data={rows} csvFilename="mercado-dinero" />
	);
}
