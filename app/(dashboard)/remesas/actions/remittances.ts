...
import type { RemittancesData } from "../types/remittances";

export async function getRemittancesData(
	period: Period = "5Y",
	...
	const [data, latest] = await Promise.all([
		getSeriesData(SERIES.REMESAS, startDate, endDate),
		getLatestValue(SERIES.REMESAS),
	]);
